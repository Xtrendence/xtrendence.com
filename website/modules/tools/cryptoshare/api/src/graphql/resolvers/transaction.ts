...
export async function createTransaction({
    ...
    try {
        ...
        if (valid) {
            ...
            db.runQuery(
                'INSERT INTO [Transaction] (transactionID, userID, transactionType, transactionDate, transactionCategory, transactionAmount, transactionNotes) VALUES (?, ?, ?, ?, ?, ?, ?)',
                [
                    transactionID,
                    userID,
                    transactionType,
...
export async function updateTransaction({
    ...
    try {
        ...
        if (valid) {
            db.runQuery(
                'UPDATE [Transaction] SET transactionType = ?, transactionDate = ?, transactionCategory = ?, transactionAmount = ?, transactionNotes = ? WHERE transactionID = ? AND userID = ?',
                [
                    transactionType,
                    transactionDate,
                    transactionCategory,
