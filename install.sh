...
cd ~/Documents/website/modules/tools/lights && npm install --force;
cd ~/Documents/website/modules/tools/cryptoshare/api && npm install --force;
cd ~/Documents/website/modules/tools/finances && npm install --force;
